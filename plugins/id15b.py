"""Online data analysis for ID15b: adapted from ID27
"""
...
logger = logging.getLogger("id15b")
...
def crysalis_config(calibration_path, calibration_name, number_of_frames,
    ...
    """
    :param calibration_path: typically "/users/opid15b/file_conversion/"
    ...
    if not os.path.exists(par_file):
        par_file = "/home/opid15b/file_conversion/scan0001.par"
    crysalis_files = {
        'par_file': par_file,
        'set_file': '/home/opid15b/file_conversion/scan0001.set',
        'ccd_file': '/home/opid15b/file_conversion/scan0001.ccd'}
...
def create_rsync_file(filename, folder="esp"):
    ...
    """
    dest_dir = os.path.dirname(filename)  # strip ... filename.h5
...
def crysalis_conversion(wave_length=None, distance=None,
    ...
    script_name = os.path.join(path, script_name)
...
{"wave_length": 0.3738,
 ...
 "file_source_path": "/data/id15b/inhouse/blc13357/id15b/Vanadinite_Weck/Vanadinite_Weck_0001/scan0001/eiger_0000.h5",
 "scan_name": "scan0001",
 "calibration_path": "/data/id15b/inhouse/blc13357/id15b/Vanadinite_Weck/Vanadinite_Weck_0001/scan0001/esp",
 "calibration_name":"scan0001",
 "plugin_name": "id15b.CrysalisConversion"
}    
    """
...
class CrysalisConversionFscannd(Plugin):
    ...
    {"wave_length": 1.54,
     ...
     "npoints":180,
     "motor_mode":"ZIGZAG",
     "dirname": "/data/id15b15b15b15b15b15b15b15b15b15b15b15b15b15b15b_name": "scan",
     "calibration_path":"/data/id15b/inhouse/sample/vanadinite",
...
class XdiConversion(Plugin):
    ...
    Typical JSON file:
    {"file_path": "/data/id15b/inhouse/some/file.h5",
     "scan_number": "0001"
    }
...
class Average(Plugin):
    ...
    Typical JSON file:
    {"file_path": "/data/id15b/inhouse/some/directory",
