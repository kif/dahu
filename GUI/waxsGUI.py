...
#UIC = get_ui_file("waxsGUI20.ui")
UIC = "waxsGUI20.ui"
FROM_PYMCA = "From PyMca"

class WaxsWidget(QtGui.QMainWindow):
    """
    """
...
#        self.connect(self.file_poni, SIGNAL("clicked()"), self.select_ponifile)
        self.connect(self.choose_mask, SIGNAL("clicked()"), self.select_maskfile)
...
#
    def select_maskfile(self):
        ...
        if maskfile:
            self.mask_filename.setText(maskfile or "")
